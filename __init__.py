...
class MinioClient:
    ...
    def __init__(self, endpoint:str, access_key:str, secret_key:str, region="us-east-1", use_https=False) -> None:
    ...
    def upload_file(self, local_file_path:str, bucket:str, object_name:str, content_type="application/octet-stream"):
        """
